---
title: "DataTrail - 06 Sharing Results"
---
...
This initial swirl module is a part of the DataTrail series and corresponds the introduction section: `06 Sharing Results` which can be [seen here without login](https://datatrail-jhu.github.io/DataTrail/sharing-results.html).
...
```r
swirl::install_course("DataTrail_06_Sharing_Results")
```

#### Manual Installation

1. Download [this](http://swirlstats.com/scn/DataTrail_06_Sharing_Results.swc) file.
