---
title: "DataTrail - 06 Share Results"
---
...
This initial swirl module is a part of the DataTrail series and corresponds the introduction section: `06 Share Results` which can be [seen here without login](https://datatrail-jhu.github.io/DataTrail/sharing-results.html).
...
```r
swirl::install_course("DataTrail_06_Share_Results")
```

#### Manual Installation

1. Download [this](http://swirlstats.com/scn/DataTrail_06_Share_Results.swc) file.
