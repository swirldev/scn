---
title: "DataTrail - 03 Cleaning the Data"
---
...
This initial swirl module is a part of the DataTrail series and corresponds the introduction section: `03 Cleaning the Data` which can be [seen here without login](https://datatrail-jhu.github.io/DataTrail/cleaning-the-data.html).
...
```r
swirl::install_course("DataTrail_03_Cleaning_the_Data")
```
