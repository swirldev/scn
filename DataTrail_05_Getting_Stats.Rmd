---
title: "DataTrail - 05 Getting Stats"
---
...
This initial swirl module is a part of the DataTrail series and corresponds the introduction section: `05 Get Stats` which can be [seen here without login](https://datatrail-jhu.github.io/DataTrail/getting-statistics.html).
...
```r
swirl::install_course("DataTrail_05_Getting_Stats")
```

#### Manual Installation

1. Download [this](http://swirlstats.com/scn/DataTrail_05_Getting_Stats.swc) file.
