---
title: "Daten einlesen und kennenlernen (in german)"
---
...
```r
swirl::install_course("Daten_einlesen_und_kennenlernen")
```

#### Manual Installation

1. Download [this](http://swirlstats.com/scn/Daten_einlesen_und_kennenlernen.swc) file.
